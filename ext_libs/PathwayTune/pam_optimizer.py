...
class PamOptimizer:
    ...
    def __init__(self, side, stim_folder, optim_settings_file, input_dict, scaling):
        ...
        self.hemiStimFolder = 'OSS_sim_files' + self.side_suffix
        self.results_folder = os.path.join(stim_folder, self.hemiStimFolder, 'Results')
        ...
        # clean-up
        try:
            os.remove(os.path.join(self.stim_folder,'NB' + self.side_suffix,'optim_iterations_CSE.csv'))
            os.remove(os.path.join(self.stim_folder,'NB' + self.side_suffix,'optim_iterations.csv'))
        except OSError:
            pass
    ...
    def compute_global_score(self, S_vector):
        ...
        estim_Ihat_json = os.path.join(self.stim_folder, 'NB' + self.side_suffix, 'Estim_symp_improv' + self.side_suffix + '.json')
