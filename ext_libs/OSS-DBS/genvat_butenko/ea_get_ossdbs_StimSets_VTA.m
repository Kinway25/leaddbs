...
[stim_folder,e_field_file,~] = fileparts(efield_contact_solutions{1,1}.fname);
...
emagn.fname = [stim_folder,filesep,'efield_magn',e_field_file(end-3:end-2),'_protocol_',num2str(stim_i),'.nii'];
ea_write_nii(emagn);
