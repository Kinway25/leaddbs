classdef ea_disctract < handle
    ...
    methods
        ...
        function calculate(obj)
            ...
            switch obj.connectivity_type
                case 2    % if PAM, then just extracts activation states from fiberActivation.mat
                    ...
                    [fibsvalBin, fibsvalSum, fibsvalMean, fibsvalPeak, fibsval5Peak, fibcell, connFiberInd, totalFibers] = ea_discfibers_calcvals_pam_prob(pamlist, obj, cfile);
                    obj.results.(ea_conn2connid(obj.connectome)).('PAM_Ttest').fibsval = fibsvalBin;
                    obj.results.(ea_conn2connid(obj.connectome)).('PAM_probA').fibsval= fibsvalSum;
        ...
        function draw(obj,vals,fibcell,usedidx) %for cv live visualize
            ...
            if obj.multi_pathways == 3 && (isequal(ea_method2methodid(obj),'VAT_Ttest') || isequal(ea_method2methodid(obj),'PAM_Ttest') || isequal(ea_method2methodid(obj),'plainconn'))% at the moment, obj.connFiberInd is defined only for OSS-DBS
