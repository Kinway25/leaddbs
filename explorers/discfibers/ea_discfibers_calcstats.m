...
% I need to enable Proportion Test and Odds Ratios for OSS-DBS
% fibsval should just take the sum, which is actually p(A)
%fibsval = obj.results.(ea_conn2connid(obj.connectome)).('spearman_sum').fibsval
